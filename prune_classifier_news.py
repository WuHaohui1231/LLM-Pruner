...
def main(args):
    ...
    num_eg = int(args.num_examples)
    small_dataset = dataset.shuffle(seed=int(args.seed)).select(range(num_eg))
    ...
    logger.log("Before pruning parameters: {}".format(before_pruning_parameters))
    ...
    path = 'imp_heat_s' + str(args.seed) + '_' + str(args.num_examples) + '_onePass_New'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_batch', help='number of batches of size 16')
